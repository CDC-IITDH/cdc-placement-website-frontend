...
const Suggestion = ({ suggestion }) => {
  ...
  return (
    <>
      <li className={css.suggestion} onMouseDown={()=>{setClicked(true)}} >
        {clicked && <Redirect to={`admin/details/placements/${suggestion.id}`} push />} {/* placement to be changed to opening type. */}
