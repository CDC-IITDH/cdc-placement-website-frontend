    ...
    return (
        <>
            ...
            <p className="mb-5 gray-blue"><b>
                <u>Note:</u> In case of different salary structures being offer to BTech and MS students, the details
                regarding the same are to be clearly mentioned in the fields below.
            </b></p>
            <MultipleFileInput stateVar={salary_file} setStateVar={setSalary_file} name="salary_file"
            ...
            <Form.Group className="mb-5 w-50">
                ...
                <Form.Control type="number" name='ctc' value={values.ctc} onChange={handleChange} onBlur={handleBlur}
            ...
            <Form.Group className="mb-5 w-50">
                ...
                <Form.Control type="number" name='gross' value={values.gross} onChange={handleChange}
                              onBlur={handleBlur} isInvalid={touched.gross && errors.gross}/>
            ...
            <Form.Group className="mb-5 w-50">
                ...
                <Form.Control type="number" name='takehome' value={values.takehome} onChange={handleChange}
                              onBlur={handleBlur} isInvalid={touched.takehome && errors.takehome}/>
                <Form.Control.Feedback type="invalid"> {errors.takehome} </Form.Control.Feedback>
                <Form.Text className="text-muted">(in INR/year)</Form.Text>
            </Form.Group>
            <Form.Group className="mb-5 w-50">
                <Form.Label>Bonus/Incentives (if any)</Form.Label>
                <Form.Control type="number" name='bonus' value={values.bonus} onChange={handleChange}
                              onBlur={handleBlur} isInvalid={touched.bonus && errors.bonus}/>
                <Form.Control.Feedback type="invalid"> {errors.bonus} </Form.Control.Feedback>
                <Form.Text className="text-muted">(in INR/year)</Form.Text>
            </Form.Group>
            <Form.Group className="mb-5">
                <Form.Label>Details of Bond (if any)</Form.Label>
                <Form.Control as="textarea" className="text-area" name='bonddetails' value={values.bonddetails}
