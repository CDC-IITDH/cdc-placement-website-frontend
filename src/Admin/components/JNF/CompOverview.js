    ...
    return (
        <>
            ...
            <Form.Group className="mb-5">
                ...
                <Form.Control type="text" name='name' value={values.name} onChange={handleChange} onBlur={handleBlur}
                              isInvalid={touched.name && errors.name}/>
                <Form.Control.Feedback type="invalid"> {errors.name} </Form.Control.Feedback>
            </Form.Group>
            <Form.Group className="mb-5">
                <Form.Label>Website Link <span className="text-danger">*</span></Form.Label>
                <Form.Control type="text" name='link' value={values.link} onChange={handleChange} onBlur={handleBlur}
                              isInvalid={touched.link && errors.link}/>
                <Form.Control.Feedback type="invalid"> {errors.link} </Form.Control.Feedback>
            </Form.Group>
            <MultipleFileInput stateVar={compdescription_file} setStateVar={setCompdescription_file}
                               name="compdescription_file" label="Brief About the Company"/>
            <Form.Group className="mb-5">
                <Form.Label>or Describe in Words</Form.Label>
                <Form.Control as="textarea" className="text-area" name="compdescription" onChange={handleChange}
                              onBlur={handleBlur}></Form.Control>
            </Form.Group>
            <Form.Group className="mb-5">
                <Form.Label>Company Address <span className="text-danger">*</span></Form.Label>
                <Form.Control as="textarea" className="text-area" name='address' value={values.address}
                              onChange={handleChange} onBlur={handleBlur}
                              isInvalid={touched.address && errors.address}></Form.Control>
                ...
                <Col sm={6}>
                    <Form.Group className="mb-5">
                        ...
                        <Form.Control type="text" name='city' value={values.city} onChange={handleChange}
                                      onBlur={handleBlur} isInvalid={touched.city && errors.city}/>
                ...
                <Col sm={6}>
                    <Form.Group className="mb-5">
                        ...
                        <Form.Control type="text" name='state' value={values.state} onChange={handleChange}
                                      onBlur={handleBlur} isInvalid={touched.state && errors.state}/>
            ...
            <Row>
                <Col sm={6}>
                    <Form.Group className="mb-5">
                        ...
                        <Form.Control type="text" name='country' value={values.country} onChange={handleChange}
                                      onBlur={handleBlur} isInvalid={touched.country && errors.country}/>
                ...
                <Col sm={6}>
                    <Form.Group className="mb-5">
                        ...
                        <Form.Control type="number" name='pincode' value={values.pincode} onChange={handleChange}
                                      onBlur={handleBlur} isInvalid={touched.pincode && errors.pincode}/>
                ...
                <Form.Check className="form-check" type="checkbox">
                    <Row>
                        {['Govt. Owned', 'MNC (Foreign Origin)', 'MNC (Indian Origin)', 'Private Sector', 'Public Sector', 'Start-Up', 'Other'].map((type) => (
                            <Col sm={6} key={type}>
                                <Form.Check.Input type="radio" label={type} name="type" value={type}
                                                  onChange={handleChange} onBlur={handleBlur}
                                                  isInvalid={touched.type && errors.type}
                                                  checked={values.type.includes(type)}></Form.Check.Input>
                ...
                <Form.Check className="form-check" type="checkbox">
                    <Row>
                        {['Manufacturing', 'Consulting', 'Finance', 'Core (Technical)', 'FMCG', 'I.T./ITeS', 'Management', 'Education (Teaching)', 'NGO', 'Research & Development', 'Other'].map((nature) => (
                            <Col key={nature} sm={6}>
                                <Form.Check.Input type="radio" label={nature} name="nature" value={nature}
                                                  onChange={handleChange} onBlur={handleBlur}
                                                  isInvalid={touched.nature && errors.nature}
                                                  checked={values.nature.includes(nature)}></Form.Check.Input>
