...
const JobProfile = ({
  ...
  return (
    <>
      ...
      <hr className="pd" />
      <MultipleFileInput
        stateVar={jobdescription_file}
        setStateVar={setJobdescription_file}
        name="jobdescription_file"
        label="Job Description"
      />
      <Form.Group className="mb-5">
        <Form.Label>
          Job Designation Offered <span className="text-danger">*</span>
        </Form.Label>
        <Form.Control
      ...
      <Form.Group className="mb-5">
        <Form.Label>
          Location(s) of Job <span className="text-danger">*</span>
        </Form.Label>
        <Form.Control
      ...
      <Form.Group className="mb-5">
        ...
        <Form.Check className="form-check" type="checkbox">
          <Row>
              ...
              <Col sm={4} key={degree}>
                <Form.Check type="checkbox">
                  <Form.Check.Input
                    ...
                    onChange={(e) => {
                      handleChange(e);
                      if (e.target.value === "BSMS") {
                        setShowDropdown(true);
                      }
                    }}
                    onBlur={handleBlur}
                    isInvalid={
                      touched.eligiblestudents && errors.eligiblestudents
                    }
                    checked={values.eligiblestudents?.includes(degree)}
                  />
            ...
            {showDropdown && (
              <Col sm={4}>
                <Form.Group>
                  <Form.Label>Select BSMS Department</Form.Label>
                  <Form.Control
                    as="select"
                    name="bsmsOption"
                    onChange={handleChange}
        ...
        <span className="select-feedback">
          {errors.eligiblestudents && touched.eligiblestudents
      ...
      <Row>
        ...
        <Col sm={6}>
          <Form.Group className="mb-3">
            ...
            <Form.Control
              name="expoffers"
              value={values.expoffers}
              onChange={handleChange}
              onBlur={handleBlur}
              isInvalid={touched.expoffers && errors.expoffers}
            />
            <Form.Control.Feedback type="invalid">
              {" "}
              {errors.expoffers}{" "}
      ...
      <Form.Group className="mb-5">
        <Form.Label>
          Is backlog students eligible to apply?{" "}
          <span className="text-danger">*</span>
        </Form.Label>
        <Row>
          {["Yes", "No"].map((eligible) => (
            <Col sm={6} key={eligible}>
              <Form.Check
                ...
                onBlur={handleBlur}
                isInvalid={
                  touched.backlogEligibility && errors.backlogEligibility
                }
        ...
        <span className="select-feedback">
          {errors.backlogEligibility && touched.backlogEligibility
      ...
      <Form.Group className="mb-5">
        <Form.Label>
          Is the position also open to PwD/ DAP?{" "}
          <span className="text-danger">*</span>
        </Form.Label>
        <Row>
          {["Yes", "No"].map((eligible) => (
        ...
        <span className="select-feedback">
          {errors.pwdEligibility && touched.pwdEligibility
      ...
      <Form.Group className="mb-5 w-50">
        ...
        <Form.Text className="text-muted">
          (in INR/year)
          <br />
          Example: If CTC is 15LPA, Enter 1500000
        </Form.Text>
      </Form.Group>
      <Form.Group className="mb-5 w-50">
        <Form.Label>
      ...
      <Form.Group className="mb-5">
        ...
        <Form.Control
          ...
          onChange={handleChange}
          onBlur={handleBlur}
          isInvalid={touched.bonddetails && errors.bonddetails}
        ></Form.Control>
        <Form.Control.Feedback type="invalid">
          {" "}
          {errors.bonddetails}{" "}
