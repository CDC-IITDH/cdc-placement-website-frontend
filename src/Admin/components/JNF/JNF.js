...
const JNF = ({setShowLoader}) => {
    ...
    return (
        <>
            <Container className="py-5 d-pink bk-container" fluid
                       style={{backgroundImage: "url(/Form_Banner.jpeg), url(/Form_Banner.jpeg), url(/Form_Banner.jpeg)"}}>
                <Row className="justify-content-center">
                    <Col className="l-pink p-5" lg={7} xs={11}>
                        {!submitted ? (
                            <Formik validateOnMount={true} validationSchema={schema} onSubmit={submit} initialValues={{
                                name: '',
                                link: '',
                                address: '',
                                city: '',
                          ...
                          We have read and understood the <a
                                                        href="https://drive.google.com/file/d/12hiRifBpIZUrZRJNXTqwcZb9ge_QbO4K/view">rules and regulations</a> put forth by the IIT Dharwad Career Development Cell
                          </span>
                                            ...
                                            {(page !== 5) ? (
                                                <Col className="text-end">
                                                    <Button variant="primary"
                                                            onClick={() => handlePageChange(setPage, page, errors, setFieldTouched, handleSubmit)}>
                                                        Next
                                                    </Button>
                                                </Col>
                                            ) : (
                            ...
                            <>
                                {error ? (
                                    <>
                                        ...
                                        <p className="text-center">We're really sorry, please try to fill the form again
                                            some other time.</p>
                                    </>
                                ) : (
                                    <>
