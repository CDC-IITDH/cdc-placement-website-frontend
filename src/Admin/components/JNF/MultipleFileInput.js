        ...
        <>
            <Form.Group className="mb-5">
                ...
                <div
                    ...
                    <Form.Control className='position-absolute top-50 start-50 translate-middle h-100'
                                  style={{opacity: 0}} type="file" multiple={true} accept="application/pdf"
                                  onChange={(event) => {
            ...
            <Dialog open={fileExceptions.length > 0 || sizeExceptions.length > 0} onClose={() => {
                setFileExceptions([]);
                setSizeExceptions([])
            }}>
            ...
            <Dialog open={filenumberExceptions} onClose={() => {
