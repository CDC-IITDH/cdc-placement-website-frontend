		...
		<div className='container-fluid p-0'>
			<nav
				...
				style={{
					...
					background:
						'linear-gradient(90deg, rgba(51, 72, 120, 1) 25%, rgba(65, 93, 156, 1) 100%)',
				}}
			>
				<Link to='\'>
					<img
						style={{ width: '300px', margin: 'auto', padding: '0.5cm' }}
						src={logo}
						alt='cdc-logo'
					/>
				</Link>
				...
				<Col className=' p-5 text-center' lg={7} xs={11}>
					{res === 200 ? (
						...
						<svg
							...
							height='40'
							fill='currentColor'
							className='bi bi-exclamation-triangle text-danger align-center justify-content-center'
							viewBox='0 0 16 16'
						>
					...
					<p className='text-center text-dark'>
						...
						{res === 500 &&
							'Please, try again after sometime. Contact CDC if problem persists'}
					</p>
				</Col>
			</Row>
		</div>
