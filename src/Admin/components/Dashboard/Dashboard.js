    ...
    if (!auth) {
      ...
      return isloading ? (
        ...
        <div className='Dashboard'>
          <h1>Dashboard</h1>
            {dashboardview &&
              <Searchbar dashboardview={dashboardview} setDashboardview={setDashboardview} setSearched = {setSearched} searched = {searched} dashboardInfo= {dashboardInfo} searchTerm={searchTerm} setSearchTerm={setSearchTerm} clearSearch={clearSearch}  />}
