        ...
        desc.map((elem) => {
          return (
            <JobCard
              ...
              btech_allowed={elem.btech_allowed}
              mtech_allowed={elem.mtech_allowed}
              ms_allowed={elem.ms_allowed}
              phd_allowed={elem.phd_allowed}
              btech_allowed_branch={elem.btech_allowed_branch}
              mtech_allowed_branch={elem.mtech_allowed_branch}
              ms_allowed_branch={elem.ms_allowed_branch}
              phd_allowed_branch={elem.phd_allowed_branch}
