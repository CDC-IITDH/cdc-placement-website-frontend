			...
			<Grid direction='row-reverse' container spacing={3}>
				<Grid item xs={12} sm={12} md={12} lg={12}>
					<Box className={classes.headingBox}>
						<Box>
							<Typography variant='h2' style={{ fontSize: '3.1rem' }}>
								{company_name}
							</Typography>
						...
						<Card variant='outlined'>
							<CardContent style={{ padding: '10px 16px' }}>
								...
								<Typography variant='h5' component='h5'>
									<span>&#8377;</span>
									{compensation_CTC
										? ` ${compensation_CTC.toLocaleString()}`
										: ''}
								</Typography>
							</CardContent>
						</Card>
				...
				<Grid item xs={12} md={8} lg={8}>
					<Box>
						{company_details || is_company_details_pdf ? (
							<div>
								<Typography
									variant='h5'
									component='h5'
									...
									? company_details_pdf_links?.map((elem, index) => {
											return (
												<Typography key={index} variant='body2' component='p'>
													<a href={elem.link}>{elem.name.substring(16)}</a>
													<br />
												</Typography>
											);
									  })
						...
						is_selection_procedure_details_pdf ? (
							<div>
								...
								{is_selection_procedure_details_pdf &&
								selection_procedure_details_pdf_links.length ? (
									<Typography variant='body1' component='body1'>
										<b> Attachments:</b>
									</Typography>
								) : (
								...
								{is_selection_procedure_details_pdf
									? selection_procedure_details_pdf_links?.map(
											(elem, index) => {
												return (
													<Typography key={index} variant='body2' component='p'>
														<a href={elem.link}>{elem.name.substring(16)}</a>
